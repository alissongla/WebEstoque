...
<body id="page-top">
  ...
  <!-- <script src="/../../public/vendor/landpage/jquery/jquery.min.js"></script> -->
  <script src="{{ asset('vendor/landpage/jquery/jquery.min.js')}}"></script>
  <!-- <script src="/../../public/vendor/landpage/bootstrap/js/bootstrap.bundle.min.js"></script> -->
  <script src="{{ asset('vendor/landpage/bootstrap/js/bootstrap.bundle.min.js')}}"></script>

  <!-- Plugin JavaScript -->
  <!-- <script src="/../../public/vendor/landpage/jquery-easing/jquery.easing.min.js"></script> -->
